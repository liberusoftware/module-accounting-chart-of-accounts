# Accounting: Chart Of Accounts Core Module

> This package is the authoritative, provider-neutral implementation of Chart Of Accounts. It owns domain behavior and data; optional API, Filament, Livewire, React, Vue, and Nuxt packages translate its public contracts for their surfaces.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-accounting-chart-of-accounts?sort=semver)](https://github.com/liberusoftware/module-accounting-chart-of-accounts/releases/latest) [![Tests](https://github.com/liberusoftware/module-accounting-chart-of-accounts/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-accounting-chart-of-accounts/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-accounting-chart-of-accounts
```
...
<a href="https://github.com/liberusoftware/module-accounting-chart-of-accounts/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-accounting-chart-of-accounts" alt="Contributors to liberusoftware/module-accounting-chart-of-accounts">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-accounting-chart-of-accounts/graphs/contributors).
